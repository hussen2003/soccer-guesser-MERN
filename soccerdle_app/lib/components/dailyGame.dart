...
class _DailyGamePageState extends State<DailyGamePage> {
  ...
  Future<void> dailyUserGuess() async {
    try {
      http.Response response = await http.post(
        Uri.parse('http://192.168.56.1:5001/api/players/getDailyPlayer'),
    ...
    try {
      http.Response response = await http.post(
        Uri.parse('http://192.168.56.1:5001/api/daily/getGuesses'),
        body: js,
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
        },
      ...
      if (!pToday) {
        ...
        try {
          var response2 = await http.post(
            Uri.parse('http://192.168.56.1:5001/api/daily/updateGuess'),
            body: js,
        ...
        try {
          var responseEnd = await http.post(
            Uri.parse('http://192.168.56.1:5001/api/daily/endGame'),
            body: json.encode({
              "username": userData["username"],
              "score": 0,
  ...
  updateHintdex(int i) async {
    ...
    try {
      var response = await http.post(
        Uri.parse('http://192.168.56.1:5001/api/daily/updateHints'),
        body: js,
        headers: {"Content-Type": "application/json"},
      );
      if (response.statusCode != 200) {
  ...
  Score(int input) async {
    ...
    try {
      var response = await http.post(
        Uri.parse('http://192.168.56.1:5001/api/daily/updateScore'),
        body: js,
        headers: {"Content-Type": "application/json"},
      );
      if (response.statusCode != 200) {
